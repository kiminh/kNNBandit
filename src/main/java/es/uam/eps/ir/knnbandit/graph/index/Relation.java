...
public interface Relation<W>
{
    ...
    public boolean removePair(int firstIdx, int secondIdx);
        ...
        /**
     * Obtains those elements in first set with relations to the ones in the second.
     * @return those elements in first set with relations to the ones in the second.
     */
    public IntStream firstsWithSeconds();
    
    /**
     * Obtains those elements in second set with relations to the ones in the first.
     * @return those elements in second set with relations to the ones in the first.
     */
     ...
     * in the second.
     * @return those elements in the first set without relations with elements
     * in the second.
     */
     ...
     * in the first.
     * @return those elements in the second set without relations with elements
     * in the first.
     */
